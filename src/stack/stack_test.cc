...
TEST(StacklDouble, Constructor_Default_Double) {
...
TEST(StackDouble, Constructor_List_double) {
  s21::stack<double> our_stack = {123.123, 243.123, 3.123, 41231.123123,
                                  45645.12333};
  std::stack<double> std_stack;
  std_stack.push(123.123);
  std_stack.push(243.123);
  std_stack.push(3.123);
  std_stack.push(41231.123123);
  std_stack.push(45645.12333);
  EXPECT_EQ(our_stack.top(), std_stack.top());
}

TEST(StackString, Swap) {
  s21::stack<std::string> our_stack_one = {"some", "dog", "shit"};
  std::stack<std::string> std_stack_one;
  std_stack_one.push("some");
  std_stack_one.push("dog");
  std_stack_one.push("shit");
  s21::stack<std::string> our_stack_second = {"nenavigu", "containers"};
  std::stack<std::string> std_stack_second;
  std_stack_second.push("nenavigu");
  std_stack_second.push("containers");
  our_stack_second.swap(our_stack_one);
  std_stack_second.swap(std_stack_one);
  EXPECT_EQ(our_stack_one.top(), std_stack_one.top());
  EXPECT_EQ(our_stack_one.empty(), std_stack_one.empty());
  EXPECT_EQ(our_stack_second.top(), std_stack_second.top());
  EXPECT_EQ(our_stack_second.empty(), std_stack_second.empty());
}
...
TEST(Stack, InsertManyFront) {
  ...
  our_stack_int.insert_many_front(4, 5, 6);
